    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(
          l10n.reminder,
          style:
              GoogleFonts.inter(fontWeight: FontWeight.bold, color: textColor),
        ),
        centerTitle: true,
          ...
          children: [
            ...
            Container(
              ...
              child: SwitchListTile(
                ...
                title: Text(
                  provider.isReminderActive
                      ? l10n.reminderActive
                      : l10n.reminderPassive,
                ...
                onChanged: (value) async {
                  ...
                  if (!success && value == true) {
                    ...
                    if (context.mounted)
                      _showPermissionDialog(context, l10n, theme, isDark);
                  } else if (value == true) {
                    // Başarıyla açıldı -> Üstten Mavi/Yeşil Bildirim
                    if (context.mounted)
                      _showTopMessage(context, l10n.notificationsSet,
                          isError: false);
                  } else {
                    // Kapatıldı -> Üstten Kırmızı Bildirim
                    if (context.mounted)
                      _showTopMessage(context, l10n.notificationsDisabled,
                          isError: true);
                  }
                },
              ),
                      ...
                      children: [
                        Expanded(
                          child: _buildTimePickerCard(
                            ...
                            onTimeChanged: (t) =>
                                provider.updateReminderSettings(start: t),
                            cardColor: cardColor,
                            textColor: textColor,
                            theme: theme,
                            isDark: isDark,
                        ...
                        Expanded(
                          child: _buildTimePickerCard(
                            ...
                            onTimeChanged: (t) =>
                                provider.updateReminderSettings(end: t),
                            cardColor: cardColor,
                            textColor: textColor,
                            theme: theme,
                            isDark: isDark,
                          ...
                          Container(
                            ...
                            child: DropdownButtonHideUnderline(
                              child: DropdownButton<int>(
                                ...
                                borderRadius: BorderRadius.circular(20),
                                dropdownColor:
                                    cardColor, // Dropdown menü arkaplanı
                                style: TextStyle(
                                    color: textColor,
                                ...
                                onChanged: (val) =>
                                    provider.updateReminderSettings(freq: val),
                              ),
                            ),
                          ),
                        ],
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color:
                  (widget.isError ? Colors.red : Colors.blue).withOpacity(0.4),
              blurRadius: 20,
