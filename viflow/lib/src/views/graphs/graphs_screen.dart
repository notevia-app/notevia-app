...
class _GraphsScreenState extends State<GraphsScreen>
      ...
      body: FutureBuilder<List<dynamic>>(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.hasError) {
            return Center(
                child: Text("${l10n.noRecordsYet} (${snapshot.error})"));
          }
          ...
          final totalDrunk =
              heatmapData.values.fold(0, (sum, val) => sum + val);
                ...
                Row(
                  children: [
                    Expanded(
                        child: _infoCard(
                            l10n.totalIntake,
                            "${(totalDrunk / 1000).toStringAsFixed(1)} L",
                            Icons.water_drop,
                            Colors.blue,
                            containerColor,
                            textColor,
                      ...
                      BarChartData(
                            ...
                            sideTitles: SideTitles(
                              ...
                              getTitlesWidget: (value, meta) {
                                ...
                                if (index >= 0 && index < weeklyData.length) {
                                  ...
                                  String dayLabel =
                                      DateFormat('E', localeCode).format(date);
                                  return Padding(
                        ...
                        barGroups: List.generate(weeklyData.length, (index) {
                          return BarChartGroupData(
                            ...
                            barRods: [
                              BarChartRodData(
                                toY: (weeklyData[index]['val'] as num)
                                    .toDouble(),
      ...
      child: Column(
        ...
        children: [
            ...
            itemBuilder: (context, index) {
              ...
              return GestureDetector(
                onTap: () {
                  if (amount > 0) {
                    String dateStr =
                        DateFormat('d MMMM yyyy', localeCode).format(dateKey);
          ...
          Row(
            ...
            children: [
              Text(isTr ? "Az" : "Less",
                  style: TextStyle(fontSize: 10, color: legendText)),
              const Gap(5),
  ...
  Map<String, double> _preparePieData(
      List<DateTime> logs, AppLocalizations l10n) {
  ...
  List<PieChartSectionData> _buildPieSections(
      Map<String, double> data, AppLocalizations l10n) {
  ...
  Widget _infoCard(String title, String val, IconData icon, Color iconColor,
